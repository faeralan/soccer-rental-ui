<template>
  ...
  <section>
    <NavbarOwner />
    <div class="container-fluid src-components-edit-court">
      <div class="container">
          <div class="row justify-content-center">
              <div class="col-12 form-box mt-5 mb-5">

                  <!-- REGISTER FORM -->
                  <form novalidate autocomplete="off" class="p-3 mt-3 mb-3 text-left" @submit.prevent="send()">

                      <h4 class="text-white text-left ml-3">Editar cancha</h4>
...
<script>
  ...
  export default  {
    name: 'src-components-edit-court',
    props: ['court_id'],
    mixins: [mixins],
    components: {
        NavbarOwner,
    ...
    methods: {
        async getCourt() {
        try {
          let data = await this.axios.get(this.url+this.court_id, { headers: {
          ...
          this.services = mydata.data.services
          this.calendar = mydata.data.calendar
          
          this.f.name =  mydata.data.name
          this.f.players= mydata.data.players
          this.f.hourprice= mydata.data.hourprice
          this.f.address= mydata.data.address
          this.f.neighborhood= mydata.data.neighborhood
          this.f.description= mydata.data.description
        ...
        sendDataFormAxios(data) {
            ...
            this.axios.put(this.url+this.court_id, data, {
                    headers: {
                        'Authorization': `Bearer ${this.$store.state.isLoggedOwner}`,
                        'Content-Type': 'application/json'
                    }
